...
export default class Calendar extends React.Component {
  ...
  showMonth = (e, month) => this.setState({
  ...
  onYearChange = ({target: {value}}) => this.setYear(value);
  ...
  render() {
    ...
    let daysinmonth = rows.map(d => <tr key={d}>{d}</tr>);
      ...
      <div className="tail-datetime-calendar">
        <div className="calendar-navi">
          ...
          {!this.state.showMonthTable && (
            <span onClick={this.showMonth} className="calendar-label">{this.month()}</span>
          )}
          <span className="calendar-label" onClick={this.showYearTable}>{this.year()}</span>
